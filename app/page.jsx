  ...
  return <main>
    ...
    <section className="section soft">
      <div className="container">
        <div className="sectionHead"><div><span className="eyebrow">VÌ SAO CHỌN VREB</span><h2>Một nền tảng, đầy đủ dữ liệu cần thiết</h2></div></div>
    ...
    <section className="section container">
      <div className="leadBox">
        <div><span className="eyebrow light">TƯ VẤN 1–1</span><h2>Nhận danh sách sản phẩm phù hợp trong hôm nay</h2><p>Chuyên viên VREB sẽ liên hệ, xác minh nhu cầu và gửi lựa chọn phù hợp.</p></div>
    ...
    <footer>
      <div className="container footerGrid">
        ...
        <div><b>Liên hệ</b><a>Hotline: 0900 000 000</a><a>Email: hello@vreb.jcv</a><a>TP.HCM, Việt Nam</a></div>
      </div>
